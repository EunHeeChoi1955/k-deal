...
var storage = function(storageType) {
    ...
    var _defaultKey = 'default-storage-key',
        ...
        _getValueObjectType = function(key, encoding) {
            try {
                var data = JSON.parse(_getData(key));
                if (encoding === true) {
                    for (var k in data) {
        ...
        _setValueObjectType = function(key, data, encoding, expires) {
            try {
                if (encoding === true) {
                    for (var k in data) {
    ...
    return {
        ...
        loadData : function (key) {
            key = key || _defaultKey;
            try {
                var data = _getValueObjectType(key, false);
        ...
        saveData : function (key, expired) {
            ...
            try {
                ...
                this.setData(key, JSON.stringify(data), expired);
            } catch (e) {
                console.error(e);
            }
        }
